    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="flex flex-col w-[500px] bg-white rounded-[2px] border border-gray-200 shadow-lg">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Delete Deployment</h2>
          <button
            onClick={handleClose}
        ...
        <div className="px-4 py-6">
          <p className="text-sm text-gray-700 mb-2">
            <strong>Are you sure you want to delete this deployment?</strong>
          </p>
          <p className="text-sm text-gray-500 mb-6">This action is permanent and irreversible.</p>
