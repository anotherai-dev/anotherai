...
const mockExperiment = (completions: any[] = [], versions: any[] = []) => ({
  id: 'exp1',
  completions,
  versions,
});
...
describe('Experiment Utilities', () => {
  ...
  describe('getMetricsPerVersion', () => {
    ...
    it('returns undefined when no annotations provided', () => {
      const result = getMetricsPerVersion(experiment as any);
      expect(result).toBeUndefined();
    });

    it('returns undefined for undefined annotations', () => {
      const result = getMetricsPerVersion(experiment as any, undefined);
      expect(result).toBeUndefined();
    });
    ...
    it('groups annotations by version correctly', () => {
      ...
      const result = getMetricsPerVersion(experiment as any, annotations);
  ...
  describe('getAllMetricsPerKeyForRow', () => {
    ...
    it('returns undefined when no annotations provided', () => {
      const result = getAllMetricsPerKeyForRow(experiment as any, undefined, 'input1');
      expect(result).toBeUndefined();
    });
    ...
    it('groups metrics by key for specific input row', () => {
      ...
      const result = getAllMetricsPerKeyForRow(experiment as any, annotations, 'input1');
    ...
    it('handles input with no completions', () => {
      ...
      const result = getAllMetricsPerKeyForRow(experiment as any, annotations, 'nonexistent_input');
  ...
  describe('Integration scenarios', () => {
    it('handles complete workflow from annotations to per-key metrics', () => {
      ...
      // Test full workflow
      const metricsPerVersion = getMetricsPerVersion(experiment as any, annotations);
      const allMetricsPerKey = getAllMetricsPerKey(metricsPerVersion);
      const rowMetrics = getAllMetricsPerKeyForRow(experiment as any, annotations, 'input1');
