...
describe("SqlKeywordExtension", () => {
  ...
  describe("Extension creation", () => {
    ...
    it("should handle case-insensitive matching", () => {
      const testCases = ["select * from users", "SELECT * FROM USERS", "Select * From Users", "sElEcT * fRoM uSeRs"];
  ...
  describe("SQL Keywords validation", () => {
    ...
    it("should recognize JOIN keywords", () => {
      ...
      const testQuery =
        "SELECT * FROM users u LEFT JOIN posts p ON u.id = p.user_id INNER JOIN comments c ON p.id = c.post_id";
