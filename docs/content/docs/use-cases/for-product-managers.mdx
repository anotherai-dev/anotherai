...
![ChatGPT with Developer Mode and AnotherAI MCP enabled](/images/mcp/chatgpt-setup.png)
...
![ChatGPT analyzing email tone debugging results](/images/email-tone-debugging-analysis.png)
</Step>
</Steps>
...
![ChatGPT creating an experiment for article summarizer improvements](/images/article-summarizer-experiment-creation.png)
</Step>

<Step>
**Review results and choose the best version**

![Experiment comparing two different prompts](/images/experiment-prompts-comparison.png)
...
![Deployment update confirmation in the AnotherAI web app](/images/deployment-update-confirmation.png)
</Step>
