...
anotherai/agent/calendar-event-extractor
```
...
for anotherai/agent/calendar-event-extractor
```
[IMAGE TODO: SCREENSHOT OF VIEW CREATED FROM THIS PROMPT]
</Step>
<Step>
...
```
Update anotherai/views/calendar-event-extractor-completions to include the completion 
inputs as well
```
