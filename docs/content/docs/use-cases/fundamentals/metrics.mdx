...
**Documentation feedback:** The sections "What sorts of data can I query?" and "How do I query and visualize my data?" overlap significantly. Consider merging these sections or restructuring to avoid redundancy.
</Callout>
...
## How do I query and visualize my data?
