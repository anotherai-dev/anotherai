...
Once your code is set up to use deployments, in many casesyou can update your agent's behavior without any engineering involvement or changes to your code.
...
<Step>
  Ask Claude (or any AI assistant) to update the existing deployment: 
...
[TODO: Add screenshot highlighting the confirmation step in the web app]
</Step>
