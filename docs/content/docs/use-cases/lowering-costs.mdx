...
Suppose you have an agent that is working well, but is used in your product very often and racking up costs. With AnotherAI your AI coding agent gets instant access to 100+ different models, so it can help you find a cheaper model that can deliver the same quality at a fraction of the cost.
...
```
Help me find the most cost effeective model to use on anotherai/agent/calendar-event-extractor. 
