...
Before optimizing costs, you need to understand your current spending. Ask your AI assistant to analyze your agent's usage:

```
Show me the cost breakdown for anotherai/agent/calendar-event-extractor over the last week. 
How much am I spending per day and what's the average cost per completion?
```
