...
![User feedback interface example](/images/user-feedback-interface.png)
...
```
<Accordions>
<Accordion title="Example script to send feedback to AnotherAI" id="sending-user-feedback-to-anotherai-via-the-annotations-endpoint">
...
![User feedback annotations view](/images/user-feedback-annotations-view.png)
...
![User feedback analysis](/images/user-feedback-analysis.png)
...
![Email Rewriter Experiment Comparison](/images/email-rewriter-experiment-comparison.png)
...
input variables for the "input" field, the output as "expected_output", and in the
an "explanation" field add the annotation content explaining why the user liked the output.
```
