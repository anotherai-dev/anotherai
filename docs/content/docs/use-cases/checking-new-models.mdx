...
Suppose you're currently using GPT-4o-mini for a given agent, but you've heard rave reviews about GPT-5 that was just released. You want to test whether the quality improvement justifies the higher cost before switching (GPT-4o mini costs $0.15 per 1M input tokens and $0.60 per 1M output tokens, while GPT 5 costs $1.25 per 1M input and $10.00 per 1M output tokens. [Source](https://platform.openai.com/docs/pricing?latest-pricing=standard)).
...
Or you can view the experiment in the AnotherAI experiments view to see the results yourself:
