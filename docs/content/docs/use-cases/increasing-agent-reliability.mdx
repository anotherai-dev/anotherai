...
<Callout type="info">
If you have any questions about our architecture, please reach out to us on [Slack](https://join.slack.com/t/anotherai-dev/shared_invite/zt-3av2prezr-Lz10~8o~rSRQE72m_PyIJA) or [GitHub](https://github.com/anotherai-dev/anotherai).
</Callout>
