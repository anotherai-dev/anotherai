...
<Callout type="tip">
Based on our experience: for complex debugging tasks, we strongly recommend switching from your default model to Claude Opus using the `/models` command in Claude Code. 
</Callout>
