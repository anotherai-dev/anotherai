...
![Meeting Prep Structured Output](/images/structured-output-json-example.png)

to

![Meeting Prep Plain Text Output](/images/structured-output-plain-text-example.png)
