...
```
Convert anotherai/agent/customer-support-agent to use structured outputs instead of returning plain text responses.
```

The will change an agent's output from something like this:

[IMAGE TODO: EXAMPLES OF UNSTRUCTURED OUTPUT]

to 

[IMAGE TODO: EXAMPLES OF STRUCTURED OUTPUT]
