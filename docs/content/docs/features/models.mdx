...
description: AnotherAI connects you to 100+ models from leading AI providers including OpenAI, Anthropic, Google, Meta, DeepSeek, Mistral, and more — all through a single, unified API.
---
...
You can list the models available to you via MCP, by asking Claude Code (or your preferred AI coding agent) to list the models:

```bash
What models are available to use on AnotherAI?
```

[IMAGE TODO: EXAPLE OF RESULTS??]
