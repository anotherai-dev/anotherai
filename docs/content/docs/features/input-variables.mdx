...
<Tabs items={['Single Variable', 'Multiple Variables', 'Complex Nested']}>
<Tab value="Single Variable">
![Single Input Variable Detail View](/images/input-variables-single-detail.png)
</Tab>
<Tab value="Multiple Variables">
![Multiple Input Variables Detail View](/images/input-variables-multiple-detail.png)
</Tab>
<Tab value="Complex Nested">
![Complex Nested Input Variables Detail View](/images/input-variables-complex-nested-detail.png)
</Tab>
</Tabs>
