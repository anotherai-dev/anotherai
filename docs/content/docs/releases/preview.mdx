---
title: MCP server designed for AI engineering
summary: Public preview
---

Today we're introducing a public preview of **AnotherAI**, a MCP server designed for AI engineering that includes a set of tools that enables your AI assistant (such as Claude Code, Cursor, etc.) to:
...
> can you test how GPT5 performs on this agent "<agent_name>"?
> ...
```
...
On top of the completions logs, collecting users' feedback is a key step to improving any AI agent. To create a fluid feedback loop, we are exposing an Annotations API to let your end-users leave feedback on completions. Then our MCP server exposes these annotations to your AI assistant.
