...
from core.runners._message_fixer import MessageAutofixer
...
class TestMessageAutofixer:
    ...
    def autofix(self):
        ...
        def _autofix(messages: list[Message]):
            ...
            return MessageAutofixer().fix(cloned)

        return _autofix

    def _content_tc_request(
        self,
        id: str = "1",
        name: str = "test",
        ...
        return MessageContent(
            tool_call_request=ToolCallRequest(
                id=id,
                tool_name=name,
                tool_input_dict=input_dict if input_dict is not None else {"hello": "world"},
            ),
        )

    def _content_tc_result(
        self,
        id: str = "1",
        name: str = "",
        input_dict: dict[str, Any] | None = None,
