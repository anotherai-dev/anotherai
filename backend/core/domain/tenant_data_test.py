...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            TenantData(
                current_credits_usd=3.0,
                low_credits_email_sent_by_threshold={800: datetime.now(tz=UTC)},
            ),
            5.0,
        ...
        pytest.param(
            TenantData(
                ...
                low_credits_email_sent_by_threshold={
                    800: datetime.now(tz=UTC),
                    600: datetime.now(tz=UTC),
                },
            ),
            5.0,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            TenantData(
                current_credits_usd=3.0,
                low_credits_email_sent_by_threshold={500: datetime.now(tz=UTC)},
            ),
            5.0,
        ...
        pytest.param(
            TenantData(
                current_credits_usd=3.0,
                low_credits_email_sent_by_threshold={300: datetime.now(tz=UTC)},
            ),
            5.0,
